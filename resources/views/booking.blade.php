               ...
               <div class="row">
                  <div class="col-md-5">
                    ...
                    @endif
                        ...
                        <form  action="/book" method='post' class="book_now">
                            @csrf
                           <div class="row">
                              <div class="col-md-12">
                                 <span>Arrival</span>
                                 <img class="date_cua" src="{{ asset('storage/images/date.png') }}">
                                 <input class="online_book" placeholder="dd/mm/yyyy"value="{{ old('date1') }}" type="date" name="date1">
                              </div>
                              <div class="col-md-12">
                                 <span>Departure</span>
                                 <img class="date_cua" src="{{ asset('storage/images/date.png') }}">
                                 <input class="online_book" placeholder="dd/mm/yyyy" value="{{ old('date1') }}" type="date" name="date2">
                              </div>
                              <input type="hidden" name="id" value="{{request('id')}}" />

                              {{-- <input type="hidden" name="metadata" value="{{ json_encode($array = [ 'investor_First_Name' => auth::user()->name, 'investor_Email' => auth::user()->email ]) }}"> --}}
